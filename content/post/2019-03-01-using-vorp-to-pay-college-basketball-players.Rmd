...
topics: []
---
Here’s the hot take: VORP should be used to pay players in college basketball, or at least be the first steps towards achieving some kind of salary distribution system for college hoops. The following table shows salaries of every Men's College Basketball Athlete's potential salary based on the VORP metric and a NBA based unionization agreement between college athletes and the NCAA. 
