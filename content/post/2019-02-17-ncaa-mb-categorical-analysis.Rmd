...
##Point Guards
```{r echo=FALSE}
datatable(pg, rownames = FALSE, filter = 'top',class = 'cell-border compact', options = list(pageLength = 5, autoWidth = TRUE , initComplete = JS(
...
##Shooting Guards
```{r echo=FALSE}
datatable(sg, rownames = FALSE, filter = 'top', class = 'cell-border compact', options = list(pageLength = 5, autoWidth = TRUE , initComplete = JS(
    "function(settings, json) {",
    "$(this.api().table().header()).css({'background-color': '#ffffff', 'color':'#000' });",
    "}")))%>%
formatStyle('FGA',color = styleInterval(c(12.9), c('red', 'green')))%>%
...
##Small Forwards
```{r echo=FALSE}
datatable(sf, rownames = FALSE, filter = 'top', class = 'cell-border compact', options = list(pageLength = 5, autoWidth = TRUE , initComplete = JS(
    "function(settings, json) {",
    "$(this.api().table().header()).css({'background-color': '#ffffff', 'color':'#000' });",
    "}")))%>%
formatStyle('FGA',color = styleInterval(c(12.9), c('red', 'green')))%>%
...
##Power Forwards
```{r echo=FALSE}
datatable(pf, rownames = FALSE, filter = 'top',class = 'cell-border compact', options = list(pageLength = 5, autoWidth = TRUE , initComplete = JS(
    "function(settings, json) {",
    "$(this.api().table().header()).css({'background-color': '#ffffff', 'color':'#000' });",
    "}")))%>%
formatStyle('FGA',color = styleInterval(c(12.9), c('red', 'green')))%>%
...
##Centers
```{r echo=FALSE}
datatable(c, rownames = FALSE, filter = 'top',class = 'cell-border compact', options = list(pageLength = 5, autoWidth = TRUE , initComplete = JS(
    "function(settings, json) {",
    "$(this.api().table().header()).css({'background-color': '#ffffff', 'color':'#000' });",
    "}")))%>%
formatStyle('FGA',color = styleInterval(c(12.9), c('red', 'green')))%>%
